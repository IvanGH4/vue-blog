<template>
    <div class="flex justify-center items-center flex-col">
        <div class="rounded-md shadow-inner w-2/5 flex items-center flex-col p-6 mt-6">
            <img class="w-16" src="@/assets/imgs/search.svg" alt="google" />
            <h3 class="font-bold tracking-wider text-xl mt-2">{{introText}}</h3>
            <button class="mt-4 w-full rounded-md bg-myBlue-light py-4 text-2xl text-white font-bold hover:opacity-80 transition" v-if="!isLogin" @click="login">
                Log In
            </button>
